    ...
    for i in range(0, loop_count):
        ...
        if event == bluez.EVT_INQUIRY_RESULT_WITH_RSSI:
            ...
            if subevent == EVT_LE_CONN_COMPLETE:
                ...
                for i in range(0, num_reports):
                    ...
                    if report_event_type == ADV_IND:
                        ...
                        try:
                          ...
                          name = "n/a"
                        Adstring = packed_bdaddr_to_string(pkt[report_pkt_offset + 3:report_pkt_offset + 9]) +",ADV_SCAN_RSP,"+"name:"+name.replace("\n", "")+","
                    else:
                        Adstring += "Unk,"
		        ...
		        for c in pkt[report_pkt_offset + 10:report_pkt_offset + 10 + report_data_length]:
